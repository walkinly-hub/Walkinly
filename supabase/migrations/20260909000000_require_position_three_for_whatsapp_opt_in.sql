-- Limits WhatsApp opt-in to customers whose final, transaction-locked
-- check-in position is 3 or higher. Existing preferences remain unchanged.
...
begin
  ...
  if coalesce(p_whatsapp_opt_in, false) and v_position < 3 then
    raise exception 'WhatsApp-Benachrichtigungen sind erst ab Warteschlangenposition 3 verfügbar.';
  end if;
